...
def variable_parameters():
    parameter_set = {
        ...
        "parameter_set_2": [0.1, 1000, 5],
        "parameter_set_3": [0.1, 1500, 5]
    }
...
def run_simulation_with_rrt_star(num_iterations, step_size, max_iter):
    ...
    for i in range(num_iterations):
        ...
        # Run RRT* algorithm
        path, tree = run_rrt_star(start, goal, obstacles, step_size, max_iter)
        ...
        drone_id = p.loadURDF(drone, basePosition=[0, 0, 0.7])
...
def metrics(parameter_set=variable_parameters()):
    ...
    for key, value in parameter_set.items():
        ...
        total_nodes, success_percentage, total_time, time_per_iteration, nodes_per_iteration, success_percentage_per_iteration, path_lengths, rrt_graphs, nodes_per_ideal_path = run_simulation_with_rrt_star(num_iterations, step_size, max_iter)
